...
namespace WhaleRiderSim
{
    ...
    public class QueryPart
    {
        ...
        private static String[][] _validcontent =
        {
            ...
            new String[] {"WHERE"},
            new String[] {"="},
            new String[] {"Sriram;DROP", "Whales;DROP", "Riding;DROP", "Id;DROP", "Databases;DROP", "Foo;DROP", "Bar;DROP", "Willy;DROP", "WP7;DROP", "Robert;DROP"},
            new String[] {"Sriram;DELETE", "Whales;DELETE", "Riding;DELETE", "Id;DELETE", "Databases;DELETE", "Foo;DELETE", "Bar;DELETE", "Willy;DELETE", "WP7;DELETE", "Robert;DELETE"},
            new String[] {";"},
            new String[] {"*"}
        }; 
        #endregion
