...
namespace WhaleRiderSim
{
    public class Bubble
    {
        ...
        private const float _spritesize = .096f;
        ...
        public Bubble()
        {
            ...
            this._centerpos = new Vector2(1f, 1f);
        ...
        public Bubble(float velocity, QueryPartType querytype)
        {
            this._rand = new Random();
            this._centerpos = new Vector2(1f, 0.6f);
            this._state = Bubble.State.Normal;
            this._velocity = new Vector2(velocity, 0f);
            ...
            this._type = this.ChooseType(this._query);
            this.acceleration = Vector2.Zero;
            switch (this._type)
            {
        ...
        public Bubble(float velocity, QueryPartType querytype, String content)
        {
            this._rand = new Random();
            this._centerpos = new Vector2(1f, 0.6f);
            this._state = Bubble.State.Normal;
            this._velocity = new Vector2(velocity, 0f);
            this._query = new QueryPart(content, querytype);
            if (this._query.Type == QueryPartType.DELETEINJECTION || this._query.Type == QueryPartType.DROPINJECTION)
            {
                this.textColor = Color.WhiteSmoke;
            }
            else
        ...
        public Bubble(Vector2 velocity, QueryPartType querytype)
        {
            this._rand = new Random();
            this._centerpos = new Vector2(1f, 0.6f);
            this._state = Bubble.State.Normal;
        ...
        public override bool Equals(object obj)
        {
            ...
            /*if (!this.spriteBoundsDest.Equals(other.spriteBoundsDest))
            {
                return false;
            }*/
        ...
        public Bubble.Type ChooseType(QueryPart query)
        {
        ...
        public void Update()
        {
            ...
            this._spriteboundssrc = new Rectangle(0, (int)this._type * Bubble._spriteboxsize, (this._type == Type.SmallGood) ? Bubble._smallspriterawxsize : Bubble._spriterawxsize, (this._type == Type.SmallGood) ? Bubble._smallspriterawysize : Bubble._spriterawysize);
            Vector2 offset;
